...
public class jdbc {
   ...
   public static void main(String[] args) {
    ...
    try {
        ...
        db_con = DriverManager.getConnection("jdbc:mysql://localhost:8889/koji_db", "koji", "japan");
        ...
        String str3 ="delete from profiles where profilesID=6";
        db_st = db_con.prepareStatement(str3);
        String str4 ="update profiles set name = '松岡　修造', age=48 ,birthday='1967-11-06' where profilesID=1";
        db_st = db_con.prepareStatement(str4);
